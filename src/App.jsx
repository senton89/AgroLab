...
// 1. ПаГиНаЦия везде
// 2. Добавить 4 репродукцию
// 3. Добавить кнопку в типы почвы (добавить тип почвы)
// 4. Мотивационная речь на первом экране?🤡
// 5. Выгрузки - нужны кнопки, по нажатию на кнопку все данные из таблицы на странице выгружаются в эксель (любой формат), если есть привязка (типо анализ к образцу) ее тоже выгрузить (по возможности)
